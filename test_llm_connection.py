#!/usr/bin/env python3
"""
Test script for custom LLM endpoint at REDACTED_ENDPOINT
...
API_KEY = "REDACTED_API_KEY"  # User key provided
...
def test_available_models():
    ...
    try:
        response = requests.get("https://REDACTED_ENDPOINT/v1/models", headers=headers, timeout=10)
...
def main():
    print("=" * 60)
    print("Custom LLM Endpoint Test - REDACTED_ENDPOINT")
    print("=" * 60)
