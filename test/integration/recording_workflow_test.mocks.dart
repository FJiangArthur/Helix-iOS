...
// in flutter_helix/test/integration/recording_workflow_test.dart.
...
import 'package:flutter_helix/core/utils/logging_service.dart' as _i11;
import 'package:flutter_helix/models/audio_configuration.dart' as _i2;
import 'package:flutter_helix/models/conversation_model.dart' as _i9;
...
import 'package:flutter_helix/services/conversation_storage_service.dart'
    as _i8;
...
/// A class which mocks [ConversationStorageService].
///
/// See the documentation for Mockito's code generation for more information.
class MockConversationStorageService extends _i1.Mock
    implements _i8.ConversationStorageService {
  MockConversationStorageService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Stream<List<_i9.ConversationModel>> get conversationStream =>
      (super.noSuchMethod(
            Invocation.getter(#conversationStream),
            returnValue: _i5.Stream<List<_i9.ConversationModel>>.empty(),
          )
          as _i5.Stream<List<_i9.ConversationModel>>);

  @override
  _i5.Future<List<_i9.ConversationModel>> getAllConversations() =>
      (super.noSuchMethod(
            Invocation.method(#getAllConversations, []),
            returnValue: _i5.Future<List<_i9.ConversationModel>>.value(
              <_i9.ConversationModel>[],
            ),
          )
          as _i5.Future<List<_i9.ConversationModel>>);

  @override
  _i5.Future<_i9.ConversationModel?> getConversation(String? id) =>
      (super.noSuchMethod(
            Invocation.method(#getConversation, [id]),
            returnValue: _i5.Future<_i9.ConversationModel?>.value(),
          )
          as _i5.Future<_i9.ConversationModel?>);

  @override
  _i5.Future<void> saveConversation(_i9.ConversationModel? conversation) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<void> updateConversation(_i9.ConversationModel? conversation) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<List<_i9.ConversationModel>> searchConversations(String? query) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<List<_i9.ConversationModel>> getConversationsByDateRange(
    DateTime? startDate,
    DateTime? endDate,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#getConversationsByDateRange, [
              startDate,
              endDate,
            ]),
            returnValue: _i5.Future<List<_i9.ConversationModel>>.value(
...
class MockTranscriptionService extends _i1.Mock
  ...
  @override
  _i5.Future<void> configureQuality(_i10.TranscriptionQuality? quality) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<void> configureBackend(_i10.TranscriptionBackend? backend) =>
      (super.noSuchMethod(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockLoggingService extends _i1.Mock implements _i11.LoggingService {
  MockLoggingService() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  void log(String? tag, String? message, _i11.LogLevel? level) =>
      super.noSuchMethod(
  ...
  @override
  List<_i11.LogEntry> getRecentLogs([int? limit]) =>
      (super.noSuchMethod(
  ...
  @override
  List<_i11.LogEntry> getFilteredLogs({
