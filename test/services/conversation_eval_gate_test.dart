...
import 'package:flutter_helix/services/tools/tool_executor.dart';
...
void main() {
  ...
  group('ConversationEvalGate', () {
    test('deterministic checks pass and report has required schema', () async {
      ...
      expect(
        ...
        containsAll(['P1', 'P2', 'Q1', 'Q2', 'A1', 'R1', 'W1', 'T1']),
      );
