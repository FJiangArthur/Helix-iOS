...
**Important Notes**:
- `llmApiKey`: Your API key for REDACTED_ENDPOINT backend (required for main LLM features)
...
- Multi-provider AI service (OpenAI, Anthropic, REDACTED_ENDPOINT)
...
## Available Models (REDACTED_ENDPOINT)
