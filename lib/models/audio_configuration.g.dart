...
_AudioConfiguration _$AudioConfigurationFromJson(Map<String, dynamic> json) =>
    _AudioConfiguration(
...
Map<String, dynamic> _$AudioConfigurationToJson(_AudioConfiguration instance) =>
    <String, dynamic>{
...
_AudioCapabilities _$AudioCapabilitiesFromJson(Map<String, dynamic> json) =>
    _AudioCapabilities(
      ...
      supportsEchoCancellation:
          json['supportsEchoCancellation'] as bool? ?? false,
...
Map<String, dynamic> _$AudioCapabilitiesToJson(_AudioCapabilities instance) =>
    <String, dynamic>{
