        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Audio Playback Controls (if audio file exists)
              if (conversation.audioFilePath != null) ...[
                const SizedBox(height: 12),
...
class _AudioPlaybackControlsState extends State<AudioPlaybackControls> {
  ...
  void _togglePlayback() async {
    ...
    try {
      // For now, just simulate playback since we need a proper audio player service
      // In a real implementation, you'd use flutter_sound player or similar
      ...
      setState(() {
        _isLoading = false;
        _errorMessage = 'Could not play audio: ${e.toString()}';
      });
    }
  }
      ...
      if (_isPlaying && mounted) {
        setState(() {
          _currentPosition = Duration(
            milliseconds: (_currentPosition.inMilliseconds + 100).clamp(
              0, 
