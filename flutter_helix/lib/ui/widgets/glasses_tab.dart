...
class _GlassesTabState extends State<GlassesTab> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _connectionStatus = GlassesConnectionStatus.connected;
    _connectedDeviceId = _discoveredDevices.first.id;
  }
            ...
            Wrap(
              ...
              children: [
                ActionChip(
                  ...
                  onPressed: _isHUDEnabled ? () {
                    // TODO: Display info on HUD
                  } : null,
                ),
                ActionChip(
