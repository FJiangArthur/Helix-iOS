...
```bash
curl https://REDACTED_ENDPOINT/v1/models \
...
```bash
curl https://REDACTED_ENDPOINT/health \
  -H "Authorization: Bearer sk-6IK5KwS53cVmhzApHGvdIA"
```
...
```bash
curl https://REDACTED_ENDPOINT/key/info \
  -H "Authorization: Bearer sk-6IK5KwS53cVmhzApHGvdIA"
```
...
4. **Cost Tracking**
   - Monitor usage via UI: https://REDACTED_ENDPOINT/ui
...
- **API Documentation**: https://REDACTED_ENDPOINT/ui/docs
- **Web UI**: https://REDACTED_ENDPOINT/ui (for key management)
- **Model List**: `curl https://REDACTED_ENDPOINT/v1/models -H "Authorization: Bearer <key>"`
- **Health Check**: `curl https://REDACTED_ENDPOINT/health -H "Authorization: Bearer <key>"`
